  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      try {
        ...
        debugPrint('Unable to load foods: $e');
      }
  ...
  void _startAutoSlide() {
    ...
    _autoSlideTimer = Timer.periodic(const Duration(seconds: 2), (_) async {
      ...
      if (pageController.hasClients) {
        try {
          await pageController.animateToPage(next,
              duration: const Duration(milliseconds: 500),
              curve: Curves.easeInOut);
        } catch (e) {
          debugPrint('Unable to auto-slide food carousel: $e');
        }
      }
    });
  }
    ...
    return Column(
      children: [
          ...
          return SizedBox(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, position) {
                final Food? f =
                    (sliderItems.isNotEmpty && position < sliderItems.length)
        ...
        Builder(builder: (ctx) {
          ...
          final rawCount = context.watch<FoodScopedModel>().items.isEmpty
              ? 5
              : context.watch<FoodScopedModel>().items.length;
          ...
          final double safePosition =
              pos < dotsCount ? pos : (dotsCount - 0.0001);
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              const Flexible(
                fit: FlexFit.loose,
                child: PrimaryText(text: "Popular"),
              ),
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => PopularFoodDetail(food: food),
                    ),
                  );
                },
                child: Container(
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: Builder(builder: (_) {
                ...
                final isNet = RegExp(r'^(http|https)://', caseSensitive: false)
                    .hasMatch(img);
                if (isNet) {
